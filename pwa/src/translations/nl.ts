export const nl = {
  ...
  "This page is temporarily unavailable": "Informatie tijdelijk niet beschikbaar",
  ...
  "The requested government information cannot currently be displayed.":
    "De gevraagde overheidsinformatie kan momenteel niet worden weergegeven.",
  "Check if you have an active internet connection.": "Controleer ook of u een actieve internetverbinding heeft.",
  "If the problem persists, please contact the municipality.":
    "Blijft het probleem zich voordoen, neem dan contact op met de gemeente.",
