...
var context_yearOptions = __webpack_require__(96799);
...
var Layout = __webpack_require__(84178);
...
const LandingTemplate=()=>{var _getItems$data3,_getItems$data3$resul,_getItems$data4,_getItems$data5,_getItems$data5$resul;const{t}=(0,es/* useTranslation */.Bd)();const{filters}=(0,context_filters/* useFiltersContext */.Y)();const{pagination,setPagination}=(0,context_pagination/* usePaginationContext */.b)();const{queryLimit,setQueryLimit}=(0,context_queryLimit/* useQueryLimitContext */.m7)();const queryClient=new react_query_es.QueryClient();const getItems=(0,openWoo/* useOpenWoo */.N)(queryClient).getAll(filters,pagination.currentPage,queryLimit.openWooObjectsQueryLimit);const[statusMessage,setStatusMessage]=react.useState("");react.useEffect(()=>{if(queryLimit.openWooObjectsQueryLimit===queryLimit.previousOpenWooObjectsQueryLimit)return;setPagination({currentPage:1});setQueryLimit(Object.assign({},queryLimit,{previousOpenWooObjectsQueryLimit:queryLimit.openWooObjectsQueryLimit}));},[queryLimit.openWooObjectsQueryLimit]);react.useEffect(()=>{var _getItems$data,_getItems$data$result,_getItems$data2,_getItems$data2$resul;if(getItems.isLoading){setStatusMessage(t("Loading results"));}else if(((_getItems$data=getItems.data)===null||_getItems$data===void 0?void 0:(_getItems$data$result=_getItems$data.results)===null||_getItems$data$result===void 0?void 0:_getItems$data$result.length)===0){setStatusMessage(t("No results found"));}else if((_getItems$data2=getItems.data)!==null&&_getItems$data2!==void 0&&(_getItems$data2$resul=_getItems$data2.results)!==null&&_getItems$data2$resul!==void 0&&_getItems$data2$resul.length){const currentPageResults=getItems.data.results.length;const currentPage=getItems.data.page||pagination.currentPage;const totalPages=getItems.data.pages;// If we have pagination info (multiple pages), provide context
...
//# sourceMappingURL=component---src-pages-index-tsx-b95ce1ff421ac01aaa22.js.map