...
| JUMBOTRON_TITLE           | Nee                   | De titel in de jumbotron-kaart; `{ORGANISATION_NAME}` wordt vervangen door de organisatienaam, bij leeg wordt de standaardtekst met de organisatienaam getoond | string, max 255 characters                           | "Woo-publicaties van {ORGANISATION_NAME}"                                                        |
| JUMBOTRON_SUBTITLE        | Nee                   | De ondertitel in de jumbotron-kaart; `{ORGANISATION_NAME}` wordt vervangen door de organisatienaam, bij leeg wordt de standaardtekst met de organisatienaam getoond | string, max 255 characters                           | "Op deze pagina vindt u de Woo-publicaties van {ORGANISATION_NAME}"                              |
