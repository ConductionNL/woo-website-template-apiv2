"use strict";
(self["webpackChunkwoo_website_template_apiv2"] = self["webpackChunkwoo_website_template_apiv2"] || []).push([[312],{
...
__webpack_require__.d(__webpack_exports__, {
  p: function() { return /* binding */ sanitizeHtml; }
});
...
if(typeof window!=="undefined"){purify.addHook("afterSanitizeAttributes",node=>{if(node instanceof Element&&node.getAttribute("target")==="_blank"){node.setAttribute("rel","noopener noreferrer");}});}const sanitizeHtml=function(html,_temp){let{allowSvg=false}=_temp===void 0?{}:_temp;if(typeof html!=="string")return"";// DOMPurify needs a browser DOM; during SSR the page content has not been fetched yet.
if(typeof window==="undefined")return"";// svg is opt-in per caller: ParsedHTML renders inline SVG from markdown
// content, the other callers have no reason to accept it.
return purify.sanitize(html,{USE_PROFILES:{html:true,svg:allowSvg},ADD_ATTR:["target"]});};

/***/ })

}]);
//# sourceMappingURL=e115a0c5c60db01075abe136e3e0a664916ac7e2-6cd86dcee5fe2c283b25.js.map